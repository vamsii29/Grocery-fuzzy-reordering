...
This project extends the fuzzy logic examples to a **grocery inventory** use case.

- Adapted the fuzzy control system to evaluate **reorder urgency** based on stock level and sales rate.  
- Applied **fuzzy c-means clustering** to group grocery items into meaningful categories (e.g., fast-moving vs slow-moving).  
- Enhanced readability, code comments, and visualizations for clarity.  

**Author:** Vamsi (University of Bern, 2025)
